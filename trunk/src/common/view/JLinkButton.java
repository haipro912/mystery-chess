...
/**
 * This class is originally from 
 * http://www.java2s.com/Code/Java/Swing-Components/LinkButton.htm 
 * 
 * @author unascribed
 */
public class JLinkButton extends JButton {
    ...
    public static void main(String[] a) {
        ...
        try {
            f.getContentPane().add(new JLinkButton("Java2s", new URL("http://www.java2s.com")));
            f.getContentPane().add(new JLinkButton("http://www.java2s.com/ExampleCode/CatalogExampleCode.htm"));
        } catch (MalformedURLException ex) {
            System.out.println("Fail to create URL");
            ex.printStackTrace();
        }
        f.setSize(600, 200);
        f.setVisible(true);
    ...
    public JLinkButton(String s) throws MalformedURLException {
        this(s, null, new URL(s));
    }
    ...
    protected void fireActionPerformed(ActionEvent event) {
        ...
        System.out.println("URL " + buttonURL.toString());
        browseURL(buttonURL.toString());
    }
    ...
    private void browseURL(String url) {
        ...
        try {
            ...
            Logger.getLogger(JLinkButton.class.getName()).log(Level.WARNING, "Fail to browse an URL", e);
        }
    }
}
