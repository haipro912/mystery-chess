...
public class RmiClient extends AbstractHost implements ClientCallback {
    ...
    private final static int MAX_RECONNECT_TIME = 30;
    private int port;
    private String host;
    private Match match;
    ...
    private void setTimeLimits() {
        try {
            ...
            Logger.getLogger(RmiClient.class.getName()).log(Level.SEVERE,
                    "Fail to get time limit constants", ex);
        }
    }

    private void register() throws RemoteException {
        try {
            Logger.getLogger(RmiClient.class.getName()).entering(this.getClass().getName(),
            ...
            Logger.getLogger(RmiClient.class.getName()).exiting(this.getClass().getName(),
